...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://telegram.me/BotsDeAyuda'),
        InlineKeyboardButton('Creator', url='https://telegram.dog/DKzippO')
    ]]
